...
def createDictFromAlbumTupple(album):
    dictionary = dict(
        name=album[0],
        artist=album[1],
    ...
    del dictionary['release_year']
    del dictionary['songs']

    dictionary.update({'release_date': '1st Match 1973'})

    print(dictionary.get('songs'))
    return dictionary

print(createDictFromAlbumTupple(album))
